...
/*   Updated: 2024/08/26 16:22:36 by atrabut          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void get_size_new_str(t_word_exp *word_ext)
{
	...
	// printf("la taille du nv mot : %d\n", word_ext->size_new_word);
	// printf("taille var_name %d\n", word_ext->size_var_name);
	// printf("taille word %d\n", word_ext->size_word);
	// printf("taille var content %d\n", word_ext->size_new_word);
}
...
int get_value(t_word_exp *word_ext, int i)
{
	...
	if (!word_ext->var_name)
		return (0);
	word_ext->var_content = getenv(word_ext->var_name);
